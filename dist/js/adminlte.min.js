                ...
                (t._fixScrollHeight = function () {
                    ...
                    if (e.hasClass(A)) {
                        var a = {
                            ...
                            i = Math.abs(
                                a.window + n.default(window).scrollTop() - a.scroll
                            ),
            ...
            return (
                ...
                (e._jQueryInterface = function (t) {
                    return this.each(function () {
                        ...
                        (a ||
                            ((a = new e(n.default(this), i)), n.default(this).data(B, a)),
                    ...
                    (a.stop(),
                        'true' === t
                            ...
                            : 'false' === t &&
                              ...
                              e.attr(ee, 'true'),
                              e.trigger(
                                  n.default.Event('expanded.lte.expandableTable')
                              )));
                }),
                (e._jQueryInterface = function (t) {
                    return this.each(function () {
                    ...
                    var i = {
                            ...
                            footer:
                                n.default(Le).length > 0
                                    ...
                                    : 0,
                            sidebar:
                                n.default(De).length > 0 ? n.default(De).height() : 0,
                            controlSidebar: a,
                        },
                        o = this._max(i),
