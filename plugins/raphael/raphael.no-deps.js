                                ...
                                if (R.vml) {
                                    ...
                                    toHex = cacher(function (color) {
                                        try {
                                            ...
                                            var value =
                                                range.queryCommandValue('ForeColor');
                                            value =
                                                ((value & 255) << 16) |
                                                (value & 65280) |
                                                ((value & 16711680) >>> 16);
                                ...
                                for (var j = 0; j < n2; j++) {
                                    ...
                                    if (is) {
                                        ...
                                        var t1 =
                                                di.t +
                                                abs(
                                                    (is[ci] - di[ci]) / (di1[ci] - di[ci])
                                                ) *
                                                    (di1.t - di.t),
                                            t2 =
                                                dj.t +
                                                abs(
                                                    (is[cj] - dj[cj]) / (dj1[cj] - dj[cj])
                                                ) *
                                                    (dj1.t - dj.t);
                                        if (
                                            t1 >= 0 &&
                                        ...
                                        if (
                                            ...
                                            switch (availableAnimAttrs[attr]) {
                                                ...
                                                case 'colour':
                                                    ...
                                                    diff[attr] = {
                                                        r:
                                                            (toColour.r - from[attr].r) /
                                                            ms,
                                                        g:
                                                            (toColour.g - from[attr].g) /
                                                            ms,
                                                        b:
                                                            (toColour.b - from[attr].b) /
                                                            ms,
                                                    };
                                                    break;
                                                case 'path':
                                                ...
                                                default:
                                                    ...
                                                    diff[attr] = [];
                                                    i =
                                                        element.paper.customAttributes[
                                                            attr
                                                        ].length;
                                                    while (i--) {
                                                        diff[attr][i] =
                                ...
                                if (!el) {
                                    ...
                                    if (type == 'linear') {
                                        ...
                                        var vector = [
                                            ...
                                            max =
                                                1 /
                                                (mmax(abs(vector[2]), abs(vector[3])) ||
                                                    1);
                                        vector[2] *= max;
                                        vector[3] *= max;
                                        if (vector[2] < 0) {
                            ...
                            setFillAndStroke = function (o, params) {
                                ...
                                if (
                                    ...
                                    opacity =
                                        ...
                                        ((+strokeColor.o + 1 || 2) - 1);
                                    var width =
                                        (toFloat(params['stroke-width']) || 1) * 0.75;
                                    opacity = mmin(mmax(opacity, 0), 1);
                                    params['stroke-width'] == null &&
                                ...
                                if (res.type == 'text') {
                                    ...
                                    fontSize =
                                        toFloat(
                                            a['font-size'] || (fontSize && fontSize[0])
                                        ) || 10;
