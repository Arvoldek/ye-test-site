                    ...
                    (n = function (t) {
                            ...
                            return h
                                ? (h[2] &&
                                  ...
                                  h[4] &&
                                      ...
                                      (n = F(l[2])),
                                      '%' == l[2].slice(-1) && (n *= 2.55),
                                      'rgba' == h[1].toLowerCase().slice(0, 4) &&
                                          (a = F(l[3])),
                                ...
                                return a.tagName
                                    ? null == r
                                        ? {
                                              ...
                                              height:
                                                  a.style.pixelHeight || a.offsetHeight,
                                          }
                        ...
                        (Wt.data = function (r, i) {
                            ...
                            if (1 == arguments.length) {
                                ...
                                return (
                                    t('raphael.data.get.' + this.id, this, n[r], r), n[r]
                                );
                            }
                            return (
                                (n[r] = i),
                                ...
                                for (var s = 1; s < r + 1; s++)
                                    n.push(
                                        i.path(a).attr({
                                            ...
                                            'stroke-width': +((e.width / r) * s).toFixed(
                                                3
                                            ),
                        ...
                        var Jt = (e.easing_formulas = {
                            ...
                            elastic: function (t) {
                                return t == !!t
                                    ? t
                                    : C(2, -10 * t) * _.sin((2 * S * (t - 0.075)) / 0.3) +
                                          1;
                            },
                            bounce: function (t) {
                                var e = 7.5625,
                            ...
                            if (u) {
                                if (c)
                                    ...
                                    for (var S in u)
                                        if (
                                            u[o](S) &&
                                            (q[o](S) || i.paper.customAttributes[o](S))
                                        )
                                            switch (
                                                ((b[S] = i.attr(S)),
                                                null == b[S] && (b[S] = j[S]),
                        ...
                        (Wt.animateWith = function (t, r, i, n, a, s) {
                            ...
                            (Wt.animate = function (t, r, i, n) {
                                ...
                                return (
                                    ae(a, this, a.percents[0], null, this.attr()), this
                                );
                            }),
                        ...
                        return (
                            ...
                            (fe.splice = function (t, e, r) {
                                ...
                                for (i = 0; i < o + n.length; i++)
                                    this.items[t + i] = this[t + i] =
                                        i < o ? s[i] : n[i - o];
                                for (
                                    i = this.items.length = this.length -= e - o;
                                    this[i];
                            ...
                            (i.add = function (t) {
                                if (e.is(t, 'array'))
                                    for (
                                        var r, i = this.set(), n = 0, s = t.length;
                                        n < s;
                                        n++
                                    )
                                        (r = t[n] || {}),
                                ...
                                b = function (i, n, a) {
                                    if ('path' == i.type) {
                                        ...
                                        if (
                                            ...
                                            M
                                                ? (g[T]++,
                                                  (A = M.getElementsByTagName('use')[0]))
                                                : ((M = x(x('marker'), {
                                                      id: T,
                                                      markerHeight: B,
                                                      markerWidth: k,
                                    ...
                                    for (var d in ((l.style.visibility = 'hidden'), a))
                                        if (a[e](d)) {
                                            ...
                                            switch (((u[d] = g), d)) {
                                                ...
                                                case 'title':
                                                    var y =
                                                        l.getElementsByTagName('title');
                                                    if (y.length && (y = y[0]))
                                                        y.firstChild.nodeValue = g;
                                                    else {
                                                        y = x('title');
                                                        var _ =
                                                            t._g.doc.createTextNode(g);
                                                        y.appendChild(_),
                                                            l.appendChild(y);
                                                    }
                                                    break;
                                                    ...
                                                    'path' == i.type &&
                                                        ...
                                                        i._.arrows &&
                                                            ('startString' in
                                                                ...
                                                                b(
                                                                    i,
                                                                    i._.arrows.startString
                                                                ),
                                                            'endString' in i._.arrows &&
                                                                b(
                                                                    i,
                                                                    i._.arrows.endString,
                                                                    1
                                                                )));
                                                    break;
                                                case 'width':
                            ...
                            (S.prototype = T),
                                ...
                                (T.transform = function (r) {
                                    ...
                                    if (
                                        ...
                                        this.pattern && m(this),
                                        this.node &&
                                            x(this.node, { transform: this.matrix }),
                                        1 != i.sx || 1 != i.sy)
                                    ) {
                    ...
                    (n = function (t) {
                        if (!t || t.vml) {
                                ...
                                C = function (n, l) {
                                    ...
                                    if ('text' == T.type) {
                                        ...
                                        (v = H.style),
                                            ...
                                            g['font-family'] &&
                                                (v.fontFamily = g['font-family']),
                                            g['font-weight'] &&
                                                (v.fontWeight = g['font-weight']),
                                            g['font-style'] &&
                            ...
                            (T.prototype = A),
                                ...
                                (A.show = function () {
                                    return (
                                        !this.removed && (this.node.style.display = f),
                                        this
                                    );
                                }),
