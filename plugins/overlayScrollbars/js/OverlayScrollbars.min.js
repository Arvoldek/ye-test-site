    ...
    function K(r, n, t, xt, _t) {
                        ...
                        if (0 < (p = W ? N : Ci(N))[A]) {
                            ...
                            if (
                                (Qt &&
                                    ...
                                    Ct.i &&
                                        y &&
                                        (en.x = Si.round(nn[le] - tn[le] + (vn.N - J)))),
                ...
                (Ot.addExt = function (n, t) {
                    ...
                    if (u) {
                        ...
                        if (
                            ...
                            return (
                                (e = (jn[n] = r).added), cn(e) == bi && e(t), Ot.ext(n)
                            );
                    } else
                        console.warn(
                                      ...
                                      function u(n) {
                                          if (a(n)) {
                                              var t = c(n),
                                                  r = {};
                                              (ne || Zr) &&
                                                  (r[de] = i.w + (t.x - e.x) * o.x),
                                                  (te || Zr) &&
                                                      (r[pe] = i.h + (t.y - e.y) * o.y),
                                                  Yt.css(r),
                                                  Oi.stpP(n);
                                          } else f(n);
                                      }
                                    ...
                                    St[e] && Vn[e] && $n[e + 's']
                                        ? ((ln[oe + i] = !o || A ? me : zt[e]),
                                          (ln[fe + i] =
                                              (n && o) || A
                                                  ? me
                                                  : zt[e] + 'px solid transparent'))
                                        : ((Jn[r.j] = ln[oe + i] = ln[fe + i] = me),
                                          (Zn = !0));
                                }),
        ...
        function ut(e) {
            var n = 'parent',
                ...
                f = [rn, en, on, ze, Se, un, fn, an, Ce, ke, Ie, Te, De, mn, Cn, Mr].join(
                    xe
                ),
                a = {};
                        ...
                        function M(n) {
                            if (R(n)) {
                                var h,
                                    t =
                                        e.vn.M /
                                        Math.round(Si.min(1, ee[e.j] / vr[e.j]) * e.vn.F),
                                    d = Si.round(ee[e.j] * t),
                                    p = 270 * t,
                                    b = 400 * t,
                                    m = e.sn.offset()[e.B],
