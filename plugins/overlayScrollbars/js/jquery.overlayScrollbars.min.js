    ...
    function z(r, n, t, xt, _t) {
                        ...
                        if (0 < (p = M ? D : Ci(D))[H]) {
                            ...
                            if (
                                (Vt &&
                                    ...
                                    Ot.i &&
                                        w &&
                                        (en.x = Oi.round(nn[le] - tn[le] + (vn.N - Q)))),
                ...
                (St.addExt = function (n, t) {
                    ...
                    if (a) {
                        ...
                        if (
                            ...
                            return (
                                (e = (Pn[n] = r).added), cn(e) == bi && e(t), St.ext(n)
                            );
                    } else
                        console.warn(
                                    ...
                                    zt[e] && qn[e] && Bn[e + 's']
                                        ? ((ln[oe + i] = !o || H ? ye : Tt[e]),
                                          (ln[ue + i] =
                                              (n && o) || H
                                                  ? ye
                                                  : Tt[e] + 'px solid transparent'))
                                        : ((Qn[r.F] = ln[oe + i] = ln[ue + i] = ye),
                                          (Zn = !0));
                                }),
        ...
        function at(e) {
            var n = 'parent',
                ...
                u = [rn, en, on, Te, ze, an, un, fn, Oe, ke, Ce, Ae, Ie, yn, On, Er].join(
                    xe
                ),
                f = {};
                        ...
                        function E(n) {
                            if (W(n)) {
                                var d,
                                    t =
                                        e.sn.D /
                                        Math.round(Oi.min(1, ee[e.F] / vr[e.F]) * e.sn.I),
                                    h = Oi.round(ee[e.F] * t),
                                    p = 270 * t,
                                    b = 400 * t,
                                    y = e.un.offset()[e.P],
