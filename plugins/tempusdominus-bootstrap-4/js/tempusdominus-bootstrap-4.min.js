                ...
                return (
                    ...
                    (i._isEnabled = function (t) {
                        ...
                        switch (t) {
                            ...
                            case 'd':
                                return (
                                    -1 !== this.actualFormat.toLowerCase().indexOf('d')
                                );
                            case 'h':
                            case 'H':
                                return (
                                    -1 !== this.actualFormat.toLowerCase().indexOf('h')
                                );
                            case 'm':
                                return -1 !== this.actualFormat.indexOf('m');
                            case 's':
                            ...
                            case 'A':
                                return (
                                    -1 !== this.actualFormat.toLowerCase().indexOf('a')
                                );
                            default:
                                return !1;
                        }
                    ...
                    (i._showMode = function (t) {
                        this.widget &&
                            ...
                            this.widget
                                ...
                                .hide()
                                .filter(
                                    '.datepicker-' + _[this.currentViewMode].CLASS_NAME
                                )
                                .show());
                    }),
                    ...
                    (i._getLastPickedDate = function () {
                        ...
                        return (
                            !t && this._options.allowMultidate && (t = n(new Date())), t
                        );
                    }),
                            ...
                            E('<tr>')
                                .append(
                                    E('<th>')
                                        ...
                                        .append(
                                            this._iconTag(this._options.icons.previous)
                                        )
                                )
                                .append(
                                    E('<th>')
