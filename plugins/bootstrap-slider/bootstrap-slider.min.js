                                ...
                                for (
                                    ...
                                    if (a <= this.options.ticks[f]) {
                                        (b = f > 0 ? this.options.ticks[f - 1] : 0),
                                            (d =
                                                f > 0
                                                    ? this.options.ticks_positions[f - 1]
                                                    : 0),
                        ...
                        toValue: function (a) {
                            ...
                            return Math.round(e) === d
                                ...
                                : ((e =
                                      this.options.min +
                                      Math.round(
                                          (e - this.options.min) / this.options.step
                                      ) *
                                          this.options.step),
                                    ...
                                    ? 'vertical' === this.options.orientation
                                        ...
                                        : (this.options.rtl
                                          ...
                                          (this.rangeHighlightElements[c].style.width =
                                              g.size + '%'))
                                    : (this.rangeHighlightElements[c].style.display =
                                          'none');
                            }
                        if (
                            Array.isArray(this.options.ticks) &&
                                ...
                                this.options.reversed && (m = 100 - m),
                                    ...
                                    this.tickLabels[l] &&
                                        ...
                                        void 0 !== this.options.ticks_positions[l]
                                            ? ((this.tickLabels[l].style.position =
                                                  'absolute'),
                                              (this.tickLabels[l].style[this.stylePos] =
                                                  m + '%'),
                        ...
                        if (c) {
                            ...
                            if (this.ticksAreValid && this.options.lock_to_ticks) {
                                ...
                                (i = this.options.ticks.indexOf(this._state.value[a])),
                                    ...
                                    (i = Math.max(
                                        0,
                                        Math.min(this.options.ticks.length - 1, i)
                                    )),
