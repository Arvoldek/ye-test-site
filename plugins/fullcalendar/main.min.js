...
var FullCalendar = (function (e) {
    ...
    function vn(e, t) {
        var n = [];
        return (
            t[''] && n.push(t['']), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), Bt(n)
        );
    }
    function gn(e, t) {
        var n = e.map(mn);
    ...
    function An(e, t, n, o, i) {
        ...
        return (
            ...
            l &&
                (u.range = { start: u.range.start, end: Nn(t.allDay, u.range.start, i) }),
    ...
    function rr(e) {
        ...
        return new Jn(
            r(r({ timeZone: wt.timeZone, calendarSystem: 'gregory' }, e), { locale: t })
        );
    }
    var or,
        ir = {
                            ...
                            for (var t = 0, a = e; t < a.length; t++) {
                                ...
                                n[s.id] ||
                                    ...
                                    (o = {
                                        ...
                                        scrollGridImpl:
                                            u.scrollGridImpl || l.scrollGridImpl,
                ...
                (t.prototype.renderWidgetGroup = function (e) {
                    for (
                        ...
                        if ('title' === c)
                            (a = !1),
                                i.push(
                                    Ar('h2', { className: 'fc-toolbar-title' }, t.title)
                                );
                        else {
                    ...
                    for (var v = 0, g = e; v < g.length; v++) {
                        ...
                        b
                            ? ((w = n[y]),
                              c.isRtl
                                  ? ((T = 0),
                                    (R = p.lefts[m.lastCol] - p.lefts[m.firstCol]))
                                  : ((R = 0),
                                    (T = p.rights[m.firstCol] - p.rights[m.lastCol])))
                            : (C = o[y]),
                            h.push(
                                Ar(
                                    'div',
                ...
                l =
                    ...
                    (function (e) {
                        ...
                        for (t = Zs.length - 1; t >= 0; t -= 1)
                            if (((n = Xe(Zs[t])), null !== (r = tt(n, e)) && r > 1))
                                return n;
                        return e;
                    })(r),
                u = [];
                                        ...
                                        r(
                                            {
                                                key:
                                                    c +
                                                    ':' +
                                                    f.eventRange.instance.instanceId,
                                                seg: f,
                                                isDragging: !1,
                                                isResizing: !1,
                                                isDateSelecting: !1,
